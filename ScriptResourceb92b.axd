Type.registerNamespace('AjaxControlToolkitPlus');AjaxControlToolkitPlus.PopupBehavior = function(element) {
AjaxControlToolkitPlus.PopupBehavior.initializeBase(this, [element]);this._x = 0;this._y = 0;this._positioningMode = AjaxControlToolkitPlus.PositioningMode.Absolute;this._parentElement = null;this._parentElementID = null;this._moveHandler = null;this._firstPopup = true;this._originalParent = null;this._visible = false;this._onShow = null;this._onShowEndedHandler = null;this._onHide = null;this._onHideEndedHandler = null;}
AjaxControlToolkitPlus.PopupBehavior.prototype = {
initialize : function() {
AjaxControlToolkitPlus.PopupBehavior.callBaseMethod(this, 'initialize');this._hidePopup();this.get_element().style.position = "absolute";this._onShowEndedHandler = Function.createDelegate(this, this._onShowEnded);this._onHideEndedHandler = Function.createDelegate(this, this._onHideEnded);},
dispose : function() {
...
this._onHideEndedHandler = null;this._onHide = null;AjaxControlToolkitPlus.PopupBehavior.callBaseMethod(this, 'dispose');},
show : function() {
if (this._visible) {
return;}
...
case AjaxControlToolkitPlus.PositioningMode.Center:
position = {
x: Math.round(parentBounds.width / 2 - width / 2),
y: Math.round(parentBounds.height / 2 - height / 2)
};break;case AjaxControlToolkitPlus.PositioningMode.BottomLeft:
position = {
x: 0,
y: parentBounds.height
};break;case AjaxControlToolkitPlus.PositioningMode.BottomRight:
position = {
x: parentBounds.width - width,
y: parentBounds.height
};break;case AjaxControlToolkitPlus.PositioningMode.TopLeft:
position = {
x: 0,
y: -element.offsetHeight
};break;case AjaxControlToolkitPlus.PositioningMode.TopRight:
position = {
x: parentBounds.width - width,
y: -element.offsetHeight
};break;case AjaxControlToolkitPlus.PositioningMode.Right:
position = {
x: parentBounds.width,
y: 0
};break;case AjaxControlToolkitPlus.PositioningMode.Left:
position = {
...
if (!this._onShow) {
this._onShow = new AjaxControlToolkitPlus.Animation.GenericAnimationBehavior(this.get_element());this._onShow.initialize();}
...
if (!this._onHide) {
this._onHide = new AjaxControlToolkitPlus.Animation.GenericAnimationBehavior(this.get_element());this._onHide.initialize();}
...
this.set_parentElement($get(this._parentElementID));Sys.Debug.assert(this._parentElement != null, String.format(AjaxControlToolkitPlus.Resources.PopupExtender_NoParentElement, this._parentElementID));} 
...
AjaxControlToolkitPlus.PopupBehavior.registerClass('AjaxControlToolkitPlus.PopupBehavior', AjaxControlToolkitPlus.BehaviorBase);AjaxControlToolkitPlus.PositioningMode = function() {
throw Error.invalidOperation();}
AjaxControlToolkitPlus.PositioningMode.prototype = {
Absolute: 0,
Center: 1,
BottomLeft: 2,
BottomRight: 3,
...
AjaxControlToolkitPlus.PositioningMode.registerEnum('AjaxControlToolkitPlus.PositioningMode');